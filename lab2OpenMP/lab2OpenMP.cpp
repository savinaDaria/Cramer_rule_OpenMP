...
//паралельний алгоритм OpenMP Fn+Ctrl+F5
#include <stdio.h>
#include <random>
#include <stdlib.h>
#include <conio.h>
...
long double GaussDeterminantCalculation(double* pMatrix, int Size)
{
	long double tmp, determinant = 1;
	int count = 1;
